...
public class AsyncrestController {
	private final static Logger logger = LoggerFactory.getLogger(AsyncrestController.class);
	...
	public String sync() {
		...
		String url = "http://localhost:8080/LogAspect/api/async/fivetime";// 休眠5秒的服务
