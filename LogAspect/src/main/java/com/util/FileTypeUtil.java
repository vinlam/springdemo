...
public class FileTypeUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		String type = getFileType("F:/t.jpg");
		System.out.println("t.jpg : " + type);
		System.out.println();
		type = getFileType("F:/tf.png");
		System.out.println("tf.png : " + type);
		System.out.println();
		type = getFileType("F:/t.txt");
		System.out.println("t.txt : " + type);
		System.out.println();

		type = getFileType("F:/tt.png");
		System.out.println("tt.png : " + type);
		System.out.println();
