 ...
 * 
 * 在创建时需要设定所有需要序列化的Root对象的Class. 特别支持Root对象是Collection的情况.
 * 
 * @author calvin
 */
public class XmlMapper {
	...
	/**
	 * Java Collection->Xml without encoding, 特别支持Root Element是Collection的情况.
	 */
	...
	/**
	 * Java Collection->Xml with encoding, 特别支持Root Element是Collection的情况.
	 */
	...
	/**
	 * 创建Marshaller并设定encoding(可为null). 线程不安全，不要每次创建或pooling
	 */
