...
import com.entity.LocationPosition;
...
public class LatitudeLontitudeUtil {  
    ...
    /** 左上角 */  
    private LocationPosition left_top = null;  
    /** 右上角 */  
    private LocationPosition right_top = null;  
    /** 左下角 */  
    private LocationPosition left_bottom = null;  
    /** 右下角 */  
    private LocationPosition right_bottom = null;  
    ...
    private void getRectangle4Point(double lat, double lng) {  
        ...
        left_top = new LocationPosition(lat + dlat, lng - dlng);  
        right_top = new LocationPosition(lat + dlat, lng + dlng);  
        left_bottom = new LocationPosition(lat - dlat, lng - dlng);  
        right_bottom = new LocationPosition(lat - dlat, lng + dlng);  
    ...
    public static LocationPosition[] getRectangle4Point(double lat, double lng,  
            double distance) {  
        LatitudeLontitudeUtil llu = new LatitudeLontitudeUtil(distance);  
        llu.getRectangle4Point(lat, lng);  
        LocationPosition[] locations = new LocationPosition[4];  
    ...
    public static void main(String[] args) {  
        ...
        LocationPosition[] locations = LatitudeLontitudeUtil.getRectangle4Point(lat,  
                lng, distance);  
