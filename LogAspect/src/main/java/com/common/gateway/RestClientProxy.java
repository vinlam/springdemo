...
public class RestClientProxy {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(RestClientProxy.class);
...
//        httpClientBuilder.setDefaultRequestConfig(requestConfig);
		...
		httpClientBuilder.setProxy(myProxy).setDefaultCredentialsProvider(credsProvider).disableCookieManagement();

		HttpClient httpClient = httpClientBuilder.build();

		// httpClient连接配置，底层是配置RequestConfig
		HttpComponentsClientHttpRequestFactory clientHttpRequestFactory = new HttpComponentsClientHttpRequestFactory(httpClient);
//		HttpComponentsClientHttpRequestWithBodyFactory clientHttpRequestFactory = new HttpComponentsClientHttpRequestWithBodyFactory(httpClient);
		// 连接超时
